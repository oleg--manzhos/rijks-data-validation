...
public class CollectionsFunctionalTest extends BaseTest {
    ...
    public void checkAllUsersetsPagination(String page, String sizePerPage, int expectedAmount) throws IOException {
        Response allCollectionsPagination = collectionsApi.getAlCollectionsWithPagination(baseUrl, "nl", page, sizePerPage);
        allCollectionsPagination.then().statusCode(200).body("artObjects.findAll{it.id}.size()", equalTo(expectedAmount));
    }
    ...
    public void checkSpecificCollectionEn() throws IOException {
        ...
        Response specificCollectionResponse = collectionsApi.getSpecificCollection(baseUrl, "en", collectionObject);
       //assertions
        specificCollectionResponse.then().statusCode(200).body("artObject.objectNumber", equalTo(collectionObject),
    ...
    public void checkSpecificCollectionNl() throws IOException {
        ...
        Response specificCollectionResponse = collectionsApi.getSpecificCollection(baseUrl, "nl", collectionObject);
       // assertions
    ...
    public void checkCollectionTiles() throws IOException {
      String objectNumber = "BK-1975-81";
        Response specificCollectionResponse = collectionsApi.getTileOfSpecificCollection(baseUrl, "nl", objectNumber);
        // assertions
        specificCollectionResponse.then().statusCode(200);
